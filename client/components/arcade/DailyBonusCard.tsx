...
export function DailyBonusCard({ userId, isConnected, isGuest = false, onSignIn }: DailyBonusCardProps) {
  ...
  const defaultRewards: DailyReward[] = [
    { day: 1, coins: 0.1, claimed: false, isToday: true },
    { day: 2, coins: 0.15, claimed: false, isToday: false },
    { day: 3, coins: 0.2, claimed: false, isToday: false },
    { day: 4, coins: 0.25, claimed: false, isToday: false },
    { day: 5, coins: 0.3, claimed: false, isToday: false },
    { day: 6, coins: 0.4, claimed: false, isToday: false },
    { day: 7, coins: 0.6, claimed: false, isToday: false },
  ];
