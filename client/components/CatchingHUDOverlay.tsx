  ...
  return (
    <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
      ...
      <View style={styles.centerHud} pointerEvents="none">
        ...
        {/* SVG Reticle Rings */}
        <Animated.View style={[styles.reticleContainer, pulseStyle]}>
          <Svg width={SCREEN_WIDTH} height={SCREEN_HEIGHT * 0.5} style={styles.svgOverlay}>
            <Defs>
              <LinearGradient id="bronzeGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <Stop offset="0%" stopColor={ObsidianBronzeAR.bronze} stopOpacity="0.8" />
                <Stop offset="100%" stopColor={ObsidianBronzeAR.amber} stopOpacity="0.6" />
              </LinearGradient>
            </Defs>

            {/* Concentric rings with dashed segments */}
            ...
            {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => {
              ...
              const innerR = 55;
              const outerR = 62;
              const x1 = SCREEN_WIDTH / 2 + Math.cos(rad) * innerR;
              const y1 = SCREEN_HEIGHT * 0.25 + Math.sin(rad) * innerR;
              const x2 = SCREEN_WIDTH / 2 + Math.cos(rad) * outerR;
              const y2 = SCREEN_HEIGHT * 0.25 + Math.sin(rad) * outerR;
              return (
                <Line
                  key={angle}
                  x1={x1}
        ...
        {/* Dust motes */}
        <Animated.View style={[styles.dustMote, styles.dust1, dustStyle1]} />
        <Animated.View style={[styles.dustMote, styles.dust2, dustStyle2]} />
        <Animated.View style={[styles.dustMote, styles.dust3, dustStyle1]} />
      </View>
